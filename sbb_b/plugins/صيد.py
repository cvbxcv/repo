...
async def _(event):
    await event.edit(
        """
أوامر الصيد الخاصة بسورس ثري ثون : 
        ...
        try:
            ch = await sbb_b(
                functions.channels.CreateChannelRequest(
                    title="THREE HUNTER - صيد ثري ثون",
                    about="This channel to hunt username by - @CCYFC ",
                )
            )
...
async def _(event):
    ...
    try:
        ...
        try:
            ch = await sbb_b(
                functions.channels.CreateChannelRequest(
                    title="THREETHON HUNTER - صيد ثري ثون",
                    about="This channel to hunt username by - @CCYFC ",
                )
            )
            ch = ch.updates[1].channel_id
