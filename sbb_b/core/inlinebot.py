...
CATLOGO = "https://graph.org/file/c2191fd744121e3c64da2.jpg"
...
def main_menu():
    text = f"**▾∮ مرحبا عزيزي {mention}**\n**▾اليكَ قائمة بازرار مضمنة لاوامر ↫**⍣ⵧⵧⵧⵧⵧᴛʜʀᴇᴇᴛʜᴏɴⵧⵧⵧⵧⵧ⍣**\n[𝗧𝗛𝗥𝗘𝗘𝗧𝗛𝗢𝗡  𝙐𝙎𝙀𝙍𝘽𝙊𝙏 🧸♥](https://t.me/CCYFC)\n\n"
    buttons = [
...
async def inline_handler(event):
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("**sbb_b"):
            buttons = [
                (
                    ...
                    Button.url("DEV", "https://t.me/CCYFC"),
                )
            ]
            ...
            result = builder.article(
                title="sbb_b Help™",
                description="**▾∮ قائمة التعليمات الخاصة ب ثري ثون **",
                text=_result[0],
                buttons=_result[1],
                link_preview=False,
            )
        ...
        buttons = [
            (
                Button.url("قناة السورس", "t.me/CCYFC"),
                Button.url(
                    "المطور",
                    "t.me/WWK3W",
                ),
        ...
        text, msg_entities = await event.client._parse_message_text(
            "لجعل ثري ثون من نصيبك!", "md"
        )
        result = types.InputBotInlineResult(
            id=str(uuid4()),
            type="photo",
            title="[𝗧𝗛𝗥𝗘𝗘𝗧𝗛𝗢𝗡  𝙐𝙎𝙀𝙍𝘽𝙊𝙏 🧸♥](https://t.me/CCYFC)",
